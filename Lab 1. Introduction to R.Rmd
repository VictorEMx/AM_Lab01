...
author: Dr. Edmundo Molina, Victor Espinoza, Josue Morales, Antonio Sebastian
output: html_document
---
# En esta linea yo voy a ingresar un cambio
...
Una vez que terminamos de usar R, escribimos q() para apagarlo, o dejarlo. Al salir de R, tenemos la opción de guardar el espacio de trabajo actual para que todos los objetos (como los conjuntos de datos) que hemos creado en esta sesión de R estén disponibles la próxima vez. Antes de salir de R, es posible que queramos guardar un registro de todos los comandos que hayamos escrito en la sesión más reciente; esto se puede realizar mediante la función savehistory(). La próxima vez que entremos en R, podemos cargar ese historial usando la función loadhistory().
